...
label_entry:
  ...
  call void @__aeabi_memclr4(i32* %v2, i32 32)
  %v3 = alloca [4 x [2 x i32]]
  %v4 = bitcast [4 x [2 x i32]]* %v3 to i32*
  call void @__aeabi_memclr4(i32* %v4, i32 32)
  ...
  call void @__aeabi_memclr4(i32* %v14, i32 32)
  ...
  call void @__aeabi_memclr4(i32* %v24, i32 32)
  ...
  call void @__aeabi_memclr4(i32* %v32, i32 32)
